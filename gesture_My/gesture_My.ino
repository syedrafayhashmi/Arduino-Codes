...
if(x>525)  //Change the value for adjusting sensitivity
forward();
else if(x<460)  //Change the value for adjusting sensitivity
backward();
else if(y>500)  //Change the value for adjusting sensitivity
left();
else if(y<420)  //Change the value for adjusting sensitivity
right();
else
stop_();
}
